...
if   curl -sS 'localhost:8000?p=details&n=1&i=1' | grep -q '<img class="big" id="big" src="1/kitchen.jpg"/>';
	then echo ' - OK   : found expected big   pic 1:1'; let nOK++;
	else echo ' - Wrong: avoid expected big   pic 1:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=1&i=1' | grep -q '<img class="small-focused" id="icon-1-1" src="1/kitchen.jpg"/>';
	then echo ' - OK   : found expected focus pic 1:1'; let nOK++;
	else echo ' - Wrong: avoid expected focus pic 1:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=1&i=1' | grep -q '<img class="small" id="icon-1-2" src="1/vestible.jpg"/>';
...
if   curl -sS 'localhost:8000?p=details&n=1&i=1' | grep -q '<a id="next" href="?p=details&n=1&i=2">.\{0,33\}Következő</a>';
...
if ! curl -sS 'localhost:8000?p=details&n=1&i=1' | grep -q '<a id="prev" href="[^"*]">.\{0,33\}Előző</a>';
...
if   curl -sS 'localhost:8000?p=details&n=1&i=2' | grep -q '<img class="big" id="big" src="1/vestible.jpg"/>';
	then echo ' - OK   : found expected big   pic 1:2'; let nOK++;
	else echo ' - Wrong: avoid expected big   pic 1:2'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=1&i=2' | grep -q '<img class="small" id="icon-1-1" src="1/kitchen.jpg"/>';
	then echo ' - OK   : found expected small pic 1:1'; let nOK++;
	else echo ' - Wrong: avoid expected small pic 1:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=1&i=2' | grep -q '<img class="small-focused" id="icon-1-2" src="1/vestible.jpg"/>';
...
if   curl -sS 'localhost:8000?p=details&n=1&i=2' | grep -q '<a id="prev" href="?p=details&n=1&i=1">.\{0,33\}Előző</a>';
...
if ! curl -sS 'localhost:8000?p=details&n=1&i=2' | grep -q '<a id="next" href="[^"*]">.\{0,33\}Következő</a>';
...
if   curl -sS 'localhost:8000?p=details&n=2&i=1' | grep -q '<img class="big" id="big" src="2/kitchen.jpg"/>';
	then echo ' - OK   : found expected big   pic 2:1'; let nOK++;
	else echo ' - Wrong: avoid expected big   pic 2:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=1' | grep -q '<img class="small-focused" id="icon-2-1" src="2/kitchen.jpg"/>';
	then echo ' - OK   : found expected focus pic 2:1'; let nOK++;
	else echo ' - Wrong: avoid expected focus pic 2:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=1' | grep -q '<img class="small" id="icon-2-2" src="2/toilet.jpg"/>';
	then echo ' - OK   : found expected small pic 2:2'; let nOK++;
	else echo ' - Wrong: avoid expected small pic 2:2'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=1' | grep -q '<img class="small" id="icon-2-3" src="2/bedroom.jpg"/>';
...
if   curl -sS 'localhost:8000?p=details&n=2&i=1' | grep -q '<a id="next" href="?p=details&n=2&i=2">.\{0,33\}Következő</a>';
	then echo ' - OK   :   possible to move focus to next picture' ; let nOK++;
	else echo ' - Wrong: impossible to move focus to next picture' ; status=Wrong;
fi; let nAll++;
if ! curl -sS 'localhost:8000?p=details&n=2&i=1' | grep -q '<a id="prev" href="[^"*]">.\{0,33\}Előző</a>';
	then echo ' - OK   : impossible to move focus to previous picture' ; let nOK++;
	else echo ' - Wrong:   possible to move focus to previous picture' ; status=Wrong;
fi; let nAll++;
...
if   curl -sS 'localhost:8000?p=details&n=2&i=2' | grep -q '<img class="big" id="big" src="2/toilet.jpg"/>';
	then echo ' - OK   : found expected big   pic 2:2'; let nOK++;
	else echo ' - Wrong: avoid expected big   pic 2:2'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=2' | grep -q '<img class="small" id="icon-2-1" src="2/kitchen.jpg"/>';
	then echo ' - OK   : found expected small pic 2:1'; let nOK++;
	else echo ' - Wrong: avoid expected small pic 2:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=2' | grep -q '<img class="small-focused" id="icon-2-2" src="2/toilet.jpg"/>';
	then echo ' - OK   : found expected focus pic 2:2'; let nOK++;
	else echo ' - Wrong: avoid expected focus pic 2:2'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=2' | grep -q '<img class="small" id="icon-2-3" src="2/bedroom.jpg"/>';
	then echo ' - OK   : found expected small pic 2:3'; let nOK++;
	else echo ' - Wrong: avoid expected small pic 2:3'; status=Wrong;
fi; let nAll++;
...
if   curl -sS 'localhost:8000?p=details&n=2&i=2' | grep -q '<a id="prev" href="?p=details&n=2&i=1">.\{0,33\}Előző</a>';
	then echo ' - OK   :   possible to move focus to previous picture' ; let nOK++;
	else echo ' - Wrong: impossible to move focus to previous picture' ; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=2' | grep -q '<a id="next" href="?p=details&n=2&i=3">.\{0,33\}Következő</a>';
	then echo ' - OK   :   possible to move focus to next picture' ; let nOK++;
	else echo ' - Wrong: impossible to move focus to next picture' ; status=Wrong;
fi; let nAll++;
...
if   curl -sS 'localhost:8000?p=details&n=2&i=3' | grep -q '<img class="big" id="big" src="2/bedroom.jpg"/>';
	then echo ' - OK   : found expected big   pic 2:3'; let nOK++;
	else echo ' - Wrong: avoid expected big   pic 2:3'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=3' | grep -q '<img class="small" id="icon-2-1" src="2/kitchen.jpg"/>';
	then echo ' - OK   : found expected small pic 2:1'; let nOK++;
	else echo ' - Wrong: avoid expected small pic 2:1'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=3' | grep -q '<img class="small" id="icon-2-2" src="2/toilet.jpg"/>';
	then echo ' - OK   : found expected small pic 2:2'; let nOK++;
	else echo ' - Wrong: avoid expected small pic 2:2'; status=Wrong;
fi; let nAll++;
if   curl -sS 'localhost:8000?p=details&n=2&i=3' | grep -q '<img class="small-focused" id="icon-2-3" src="2/bedroom.jpg"/>';
...
if   curl -sS 'localhost:8000?p=details&n=2&i=3' | grep -q '<a id="prev" href="?p=details&n=2&i=2">.\{0,33\}Előző</a>';
	then echo ' - OK   :   possible to move focus to previous picture' ; let nOK++;
	else echo ' - Wrong: impossible to move focus to previous picture' ; status=Wrong;
fi; let nAll++;
if ! curl -sS 'localhost:8000?p=details&n=2&i=3' | grep -q '<a id="next" href="[^"]*">.\{0,33\}Következő</a>';
	then echo ' - OK   : impossible to move focus to next picture' ; let nOK++;
	else echo ' - Wrong:   possible to move focus to next picture' ; status=Wrong;
fi; let nAll++;
